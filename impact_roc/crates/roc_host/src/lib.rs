...
pub fn init() {
    let funcs: &[*const extern "C" fn()] = &[
        ...
        roc_fx_vec3_f32_roundtrip as _,
        roc_fx_vec4_f32_roundtrip as _,
        roc_fx_vec3_f64_roundtrip as _,
        roc_fx_vec4_f64_roundtrip as _,
        roc_fx_test_struct_roundtrip as _,
    ];
...
pub extern "C" fn roc_fx_f32_to_bits(value: f32) -> u32 {
    roc_rosetta::f32_to_bits(value)
}

#[no_mangle]
pub extern "C" fn roc_fx_f64_to_bits(value: f64) -> u64 {
    roc_rosetta::f64_to_bits(value)
}

#[no_mangle]
pub extern "C" fn roc_fx_f32_from_bits(bits: u32) -> f32 {
    roc_rosetta::f32_from_bits(bits)
}

#[no_mangle]
pub extern "C" fn roc_fx_f64_from_bits(bits: u64) -> f64 {
    roc_rosetta::f64_from_bits(bits)
}

#[no_mangle]
pub extern "C" fn roc_fx_vec3_f32_roundtrip(bytes: &RocList<u8>) -> RocResult<RocList<u8>, RocStr> {
    to_roc_result(roc_rosetta::vec3_f32_roundtrip(bytes))
}

#[no_mangle]
pub extern "C" fn roc_fx_vec4_f32_roundtrip(bytes: &RocList<u8>) -> RocResult<RocList<u8>, RocStr> {
    to_roc_result(roc_rosetta::vec4_f32_roundtrip(bytes))
}

#[no_mangle]
pub extern "C" fn roc_fx_vec3_f64_roundtrip(bytes: &RocList<u8>) -> RocResult<RocList<u8>, RocStr> {
    to_roc_result(roc_rosetta::vec3_f64_roundtrip(bytes))
}

#[no_mangle]
pub extern "C" fn roc_fx_vec4_f64_roundtrip(bytes: &RocList<u8>) -> RocResult<RocList<u8>, RocStr> {
    to_roc_result(roc_rosetta::vec4_f64_roundtrip(bytes))
}

#[no_mangle]
pub extern "C" fn roc_fx_test_struct_roundtrip(
    bytes: &RocList<u8>,
) -> RocResult<RocList<u8>, RocStr> {
    to_roc_result(roc_rosetta::test_struct_roundtrip(bytes))
}
