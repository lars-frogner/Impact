...
/// ```
///
/// The macro takes as input a [`PrototypeEntities`](world::PrototypeEntities)
/// representing a set of entities of the same prototype (i.e. archetype, but
/// subject to change), followed by a closure definition whose argument
/// signature specifies the set of [`Component`](component::Component) types to
/// look for in the prototype. The first argument to the closure may optionally
/// have the [`EntityID`](impact_id::EntityID) type. The closure's return type
