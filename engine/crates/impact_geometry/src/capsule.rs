...
pub struct CapsulePointContainmentTester {
    segment_start: Point3<f32>,
    segment_vector: Vector3<f32>,
    segment_vector_over_length_squared: Vector3<f32>,
    radius_squared: f32,
}
...
impl Capsule {
    ...
    pub fn new(segment_start: Point3<f32>, segment_vector: Vector3<f32>, radius: f32) -> Self {
        assert!(radius >= 0.0);
        Self {
            segment_start,
            segment_vector,
    ...
    pub fn segment_vector(&self) -> &Vector3<f32> {
        &self.segment_vector
    }
...
impl CapsulePointContainmentTester {
    ...
    pub fn shortest_squared_distance_from_point_to_segment(&self, point: &Point3<f32>) -> f32 {
