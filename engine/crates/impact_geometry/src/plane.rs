...
impl Plane {
    ...
    pub fn rotated(&self, rotation: &UnitQuaternion) -> Self {
        let rotated_unit_normal =
            UnitVector3::unchecked_from(rotation.rotate_vector(&self.unit_normal));
    ...
    pub fn transformed(&self, transform: &Similarity3) -> Self {
        ...
        let transformed_unit_normal =
            UnitVector3::unchecked_from(transform.rotation().rotate_vector(&self.unit_normal));
...
mod tests {
    ...
    use impact_math::{consts::f32::SQRT_2, vector::Vector3};
