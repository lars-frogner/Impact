...
impl DragLoad {
    ...
    pub fn compute_world_space_drag_force_and_torque(
        ...
        let world_space_force =
            force_scaling * body_orientation.rotate_vector(&self.force.aligned());
        let world_space_torque =
            torque_scaling * body_orientation.rotate_vector(&self.torque.aligned());
...
pub fn compute_aggregate_drag_load_for_direction(
    ...
    for triangle in mesh_triangles {
        ...
        if cos_impact_angle > 0.0 {
            ...
            let drag_torque = (triangle.center.aligned() - center_of_mass).cross(&drag_force);
