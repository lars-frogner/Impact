...
use impact_geometry::{Capsule, ModelTransform, ReferenceFrame, Sphere};
use impact_physics::{
    fph,
...
pub fn apply_absorption(
    ...
    query!(ecs_world, |entity_id: EntityID,
        ...
        let (object, inertial_property_manager) = voxel_manager
            .object_manager
            .get_voxel_object_with_inertial_property_manager_mut(*voxel_object_id);

        let object = object
            .expect("Missing voxel object for entity with VoxelObjectID")
            .object_mut();

        let inertial_property_manager = inertial_property_manager
            .expect("Missing inertial property manager for entity with VoxelObjectID");
...
fn handle_voxel_object_after_removing_voxels(
    ...
    let rigid_body = rigid_body_manager
        ...
        .expect("Missing dynamic rigid body for entity with VoxelObjectID");
