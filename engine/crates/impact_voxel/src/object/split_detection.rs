...
pub struct SplitDetector {
    ...
    pub(crate) regions: Vec<LocalRegion>,
    pub(crate) original_uniform_chunk_count: usize,
...
pub struct NonUniformChunkSplitDetectionData {
    ...
    pub(crate) region_count: LocalRegionCount,
    /// The number of local connected regions in this chunk that touch the chunk
    /// boundary.
    pub(crate) boundary_region_count: LocalRegionCount,
}
...
pub(crate) struct LocalRegion {
    ...
    pub(crate) parent_label: GlobalRegionLabel,
...
pub(crate) const CHUNK_MAX_REGIONS: usize = 1 << LOG2_MAX_REGIONS_PER_CHUNK;
...
impl GlobalRegionLabel {
    ...
    #[inline]
    pub(crate) fn new(chunk_idx: u32, region_idx: u32) -> Self {
...
#[inline]
pub(crate) const fn non_uniform_chunk_start_region_idx(
...
#[inline]
pub(crate) fn chunk_voxel_region_labels(
...
#[inline]
pub(crate) fn non_uniform_chunk_regions(
    regions: &[LocalRegion],
    uniform_chunk_count: usize,
    data_offset: u32,
) -> &[LocalRegion] {
...
#[inline]
fn assign_parent_to_voxel(parents: &mut [u16], voxel_idx: usize, parent_idx: usize) {
...
pub(crate) fn find_root_for_region(
    chunks: &[VoxelChunk],
    regions: &[LocalRegion],
    uniform_chunk_count: usize,
    region_label: GlobalRegionLabel,
...
fn object_region_idx_for_region_in_chunk(
    ...
    match unsafe { chunks.get_unchecked(chunk_idx) } {
        ...
        VoxelChunk::Uniform(UniformVoxelChunk {
            split_detection, ..
        }) => split_detection.data_offset as usize,
