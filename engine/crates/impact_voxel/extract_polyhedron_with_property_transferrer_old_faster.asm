...
.LBB226_105:
	...
	addq $16, %rax
	movq %rcx, 1144(%rsp)
	vmovaps %xmm0, 1872(%rsp)
	vcvtusi2ss %rax, %xmm15, %xmm0
	vmovaps %xmm0, 1856(%rsp)
	jmp .LBB226_108
	.p2align	4
.LBB226_106:
	movq 24(%rsp), %rax
...
.LBB226_108:
	...
	vmovaps 1872(%rsp), %xmm0
	addq $16, %rcx
	movq %rax, 1160(%rsp)
	vmovaps %xmm1, 1968(%rsp)
	vinsertps $16, %xmm1, %xmm0, %xmm0
	vcvtusi2ss %rcx, %xmm15, %xmm1
	vmovaps %xmm0, 1936(%rsp)
	vmovaps 1856(%rsp), %xmm0
	movq 312(%rsp), %rcx
...
.LBB226_112:
	...
	vshufps $4, %xmm1, %xmm3, %xmm3
		...
		Self {
	vmovaps %xmm2, 2048(%rsp)
	vmovaps %xmm3, 2064(%rsp)
	.p2align	4
.LBB226_115:
		// ~/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/library/core/src/ptr/non_null.rs:1714
		self.as_ptr() == other.as_ptr()
...
.LBB226_170:
		// ~/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/library/core/src/cmp.rs:1038
		if other < self { self } else { other }
	movzbl 1728(%rsp,%rcx), %edx
	movzbl -1(%r11,%r12), %esi
...
.LBB226_177:
	...
	cmpl %r9d, %ecx
	cmoval %ecx, %r9d
		// crates/impact_voxel/src/object/extraction.rs:1005
		if k == 0 {
	cmpq $1, %r12
	adcq $0, 264(%rsp)
	movl %r9d, 104(%rsp)
...
.LBB226_179:
	...
	cmpl %r8d, %ecx
	cmoval %ecx, %r8d
		// crates/impact_voxel/src/object/extraction.rs:966
		if k == 0 {
	testl %ecx, %ecx
	je .LBB226_183
	cmpl $15, %ecx
...
.LBB226_210:
	...
	vcvtuqq2psx 224(%rsp), %xmm1
	vmovaps 1888(%rsp), %xmm2
	movq 288(%rsp), %rax
	movq 168(%rsp), %rcx
		// crates/impact_voxel/src/object/inertia.rs:709
		let density = voxel_type_densities[voxel_type.idx()];
	...
	vcvtusi2ssq 240(%rsp), %xmm15, %xmm3
	vmovaps 1904(%rsp), %xmm4
		// ~/.rustup/toolchains/stable-x86_64-unknown-linux-gnu/lib/rustlib/src/rust/library/core/src/../../stdarch/crates/core_arch/src/macros.rs:173
		$crate::intrinsics::simd::simd_shuffle(
...
.LBB226_238:
	...
	vmovss 1376(%rsp), %xmm0
	vmovaps 1344(%rsp), %xmm1
	vmovaps 1360(%rsp), %xmm2
	vmovaps 1392(%rsp), %xmm3
	movq 168(%rsp), %rcx
...
.LBB226_380:
	...
	movq %r15, 2024(%rsp)
		// crates/impact_voxel/src/object/extraction.rs:1248
		let extraction_result = Self::complete_extracted_voxel_object(
	vpermi2q 1280(%rsp), %ymm2, %ymm3
	vmovdqa %xmm4, 1984(%rsp)
		// crates/impact_voxel/src/object/extraction.rs:1258
		poly_invalidated_mesh_chunk_indices,
	vmovups %xmm1, 2032(%rsp)
		// crates/impact_voxel/src/object/extraction.rs:1248
		let extraction_result = Self::complete_extracted_voxel_object(
	movq %rax, 2000(%rsp)
	movq 312(%rsp), %rax
	...
	vmovups 2304(%rsp), %zmm1
	vmovups 2368(%rsp), %zmm0
	vmovdqu64 2048(%rsp), %zmm4
	vmovups 2176(%rsp), %zmm2
	vmovdqu64 2240(%rsp), %zmm3
	vmovups %zmm1, 1600(%rsp)
	vmovups 2112(%rsp), %zmm1
	vmovups %zmm0, 1664(%rsp)
	vmovdqu64 %zmm3, 1536(%rsp)
	vmovups %zmm2, 1472(%rsp)
	vmovdqu64 %zmm4, 1344(%rsp)
	vmovups %zmm1, 1408(%rsp)
	.cfi_escape 0x2e, 0x00
	leaq 1344(%rsp), %rdi
	...
	vmovups 1600(%rsp), %zmm1
	vmovdqu64 1664(%rsp), %zmm0
	vmovdqu64 1344(%rsp), %zmm4
	vmovdqu64 1472(%rsp), %zmm2
