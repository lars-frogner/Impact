//! GPU compute passes for rendering.
...
impl ComputePass {
    ...
    pub fn record(
        ...
        let (surface_width, surface_height) = rendering_surface.surface_dimensions();

        let [x, y, z] = self
            .shader_template
            .determine_workgroup_counts(surface_width, surface_height);
