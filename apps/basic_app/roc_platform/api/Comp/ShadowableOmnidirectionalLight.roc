# Hash: 396566e17b7df323fa9f379029891e66250cb4cee1a8dff6b78be1d913c072e1
# Generated: 2025-06-23T21:05:32+00:00
# Rust type: impact_light::components::ShadowableOmnidirectionalLightComp
...
## Adds a value of the [ShadowableOmnidirectionalLight] component to an entity's data.
...
## Serializes a value of [ShadowableOmnidirectionalLight] into the binary representation
## expected by the engine and appends the bytes to the list.
write_bytes : List U8, ShadowableOmnidirectionalLight -> List U8
write_bytes = |bytes, value|
    bytes
    |> List.reserve(4)
    |> Light.LightID.write_bytes(value.id)

## Deserializes a value of [ShadowableOmnidirectionalLight] from its bytes in the
## representation used by the engine.
from_bytes : List U8 -> Result ShadowableOmnidirectionalLight _
from_bytes = |bytes|
    Ok(
        {
