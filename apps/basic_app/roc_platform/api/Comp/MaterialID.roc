...
add : Entity.ComponentData, MaterialID -> Entity.ComponentData
...
add_multiple : Entity.MultiComponentData, Entity.Arg.Broadcasted (MaterialID) -> Result Entity.MultiComponentData Str
...
read : Entity.ComponentData -> Result MaterialID Str
read = |data|
