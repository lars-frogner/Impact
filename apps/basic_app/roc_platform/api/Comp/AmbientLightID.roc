# Hash: f19b55bff7e79bccc0418bd5d4bef113829109a921d6eb1ea0489fff1012ace4
...
add : Entity.ComponentData, AmbientLightID -> Entity.ComponentData
...
add_multiple : Entity.MultiComponentData, Entity.Arg.Broadcasted (AmbientLightID) -> Result Entity.MultiComponentData Str
...
## The ID of the [AmbientLightID] component.
component_id = 11467547545941186241

## Adds the ID of the [AmbientLightID] component to the component list.
add_component_id : Entity.ComponentIds -> Entity.ComponentIds
add_component_id = |component_ids|
    component_ids |> Entity.append_component_id(component_id)

## Reads the component from the given entity data. 
read : Entity.ComponentData -> Result AmbientLightID Str
read = |data|
    Entity.read_component(data, component_id, from_bytes)
    |> Result.map_err(
        |err|
            when err is
                ComponentMissing -> "No AmbientLightID component in data"
                Decode(decode_err) -> "Failed to decode AmbientLightID component: ${Inspect.to_str(decode_err)}",
    )

## Fetches the value of this component for the given entity.
get_for_entity! : Entity.Id => Result AmbientLightID Str
get_for_entity! = |entity_id|
    Entity.get_component!(entity_id, component_id)? |> read

## Sets the value of this component for the given entity to the
## specified value.
set_for_entity! : AmbientLightID, Entity.Id => Result {} Str
