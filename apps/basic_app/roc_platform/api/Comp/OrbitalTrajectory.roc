# Hash: ca66d006f805f99a6ce5befe35d12d4484d81bcf433085871290f95b832c11fd
...
add_new = |data, periapsis_time, orientation, focal_position, semi_major_axis, eccentricity, period|
    add(data, new(periapsis_time, orientation, focal_position, semi_major_axis, eccentricity, period))
...
add_multiple : Entity.MultiData, List OrbitalTrajectory -> Entity.MultiData
