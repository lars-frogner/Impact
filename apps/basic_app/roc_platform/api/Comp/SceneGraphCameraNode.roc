# Hash: 21908d16b569f70bc6d3db1962d0449615452fe1f0ee01fbeefabeb5549d0a75
...
add_multiple : Entity.MultiData, Entity.Arg.Broadcasted (SceneGraphCameraNode) -> Result Entity.MultiData Str
add_multiple = |entity_data, comp_values|
    entity_data
    |> Entity.append_components(write_multi_packet, Entity.Arg.broadcast(comp_values, Entity.multi_count(entity_data)))
    |> Result.map_err(
        |CountMismatch(new_count, orig_count)|
            "Got ${Inspect.to_str(new_count)} values in SceneGraphCameraNode.add_multiple, expected ${Inspect.to_str(orig_count)}",
    )
