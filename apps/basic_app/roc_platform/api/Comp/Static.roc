...
## Adds the [Static] component to an entity's data.
add : Entity.Data -> Entity.Data
add = |entity_data|
    entity_data |> Entity.append_component(write_packet, {})

## Adds the [Static] component to each entity's data.
...
add_multiple = |entity_data|
    ...
    when res is
        ...
        Err(err) -> crash "unexpected error in Static.add_multiple: ${Inspect.to_str(err)}"
