# Hash: 03f71eaeff6560d2212108f65ae6379d9046be3743c777f915e7169006740dcf
...
add_new = |data, length, max_diameter, n_circumference_vertices|
    add(data, new(length, max_diameter, n_circumference_vertices))
...
add_multiple : Entity.MultiData, List ConeMesh -> Entity.MultiData
