...
add : Entity.ComponentData, SphericalLightVolumeMesh -> Entity.ComponentData
...
add_multiple : Entity.MultiComponentData, Entity.Arg.Broadcasted (SphericalLightVolumeMesh) -> Result Entity.MultiComponentData Str
