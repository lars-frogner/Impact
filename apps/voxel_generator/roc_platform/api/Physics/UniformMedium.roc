# Hash: eefc89f2fca28171cb19922b81d575005cbf0c0d7e80b46a261e447798c9d5cf
...
new : F32, Vector3.Vector3 Binary32 -> UniformMedium
...
moving_air : Vector3.Vector3 Binary32 -> UniformMedium
moving_air = |velocity|
...
moving_water : Vector3.Vector3 Binary32 -> UniformMedium
    ...
    Ok(
        {
            ...
            velocity: bytes |> List.sublist({ start: 4, len: 12 }) |> Vector3.from_bytes_32?,
        },
    )
